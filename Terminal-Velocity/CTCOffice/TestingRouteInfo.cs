...
namespace CTCOffice
{
    public class TestingRouteInfo: IRouteInfo
        {
        //Private parameters
        private IBlock[] _blockList;
        ...
        public TestingRouteInfo(int rID, string rName, int nBlocks, IBlock[] blocks, int sID, int eID)
        {
            _routeID = rID;
            _routeName = rName;
            _numBlocks = nBlocks;
